...
- W5500 Ethernet Module (SPI)  
  https://www.amazon.com/dp/B08KXM8TKJ

### User I/O
- Momentary push button (panel mount)  
  https://www.amazon.com/dp/B0CLG7Z5JS

### Connectors / pass-through
- USB bulkhead passthrough  
  https://www.amazon.com/dp/B0D17N33TX
- Panel-mount button bulkhead  
  https://www.amazon.com/dp/B0D9B7WR23
- RJ45 keystone jack  
  https://www.amazon.com/dp/B09W8RST25

### Mechanical
- Enclosure screws  
  https://www.amazon.com/dp/B0D2R68YBC
- Heat-set threaded inserts  
  https://www.amazon.com/dp/B0CS6YVJYD

### Cables / wiring
- Ethernet patch cable  
  https://www.amazon.com/dp/B0B57RDX6P
- USB power cable  
  https://www.amazon.com/dp/B07232M876

Note: The USB and Ethernet cables were cut and shortened to length during assembly rather than used as-is.

### Tools

- Punchdown tool (for terminating the RJ45 keystone)  
...
The enclosure is a simple custom design for this project. The 3D printable parts are in the `/mechanical` folder:
...
See the `/docs` folder for photos. 

---

## Setup

1. Wire the ESP32, W5500, and button as shown above.
2. Flash the firmware.
3. Hold the button while powering on to enter learn mode.
4. Generate network traffic on the target computer so the device can learn its MAC.
5. The device saves the MAC and reboots into normal mode.
6. Press the button to wake the computer.

---

## Firmware

The ESP32 firmware is located in `/src/wol_button.ino`.
